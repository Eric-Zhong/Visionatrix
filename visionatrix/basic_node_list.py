...
ANTELOPEV2 = AIResourceModel(
    ...
    url="https://hf-mirror.com/MonsterMMORPG/tools/resolve/main/antelopev2.zip",
...
BASIC_NODE_LIST = {
    "comfyui-impact-pack@8.8.1": {
        "models": [
            AIResourceModel(
                ...
                url="https://hf-mirror.com/andrey18106/visionatrix_models/resolve/main/mmdet/bbox/mmdet_anime-face_yolov3.pth",
                homepage="https://hf-mirror.com/Bingsu/adetailer",
            ...
            AIResourceModel(
                ...
                # url="https://hf-mirror.com/andrey18106/visionatrix_models/raw/main/mmdet/bbox/mmdet_anime-face_yolov3.py",
                url="https://hf-mirror.com/andrey18106/visionatrix_models/resolve/main/mmdet/bbox/mmdet_anime-face_yolov3.py",
                homepage="https://hf-mirror.com/Bingsu/adetailer",
            ...
            AIResourceModel(
                ...
                url="https://hf-mirror.com/andrey18106/visionatrix_models/resolve/main/sams/sam_vit_b_01ec64.pth",
    ...
    "comfyui-impact-subpack@1.2.9": {
        "models": [
            AIResourceModel(
                name="face_yolov8m",
                url="https://hf-mirror.com/andrey18106/visionatrix_models/resolve/main/ultralytics/bbox/face_yolov8m.pt",
                homepage="https://hf-mirror.com/Bingsu/adetailer",
            ...
            AIResourceModel(
                name="hand_yolov8s",
                url="https://hf-mirror.com/andrey18106/visionatrix_models/resolve/main/ultralytics/bbox/hand_yolov8s.pt",
                homepage="https://hf-mirror.com/Bingsu/adetailer",
            ...
            AIResourceModel(
                ...
                url="https://hf-mirror.com/andrey18106/visionatrix_models/resolve/main/ultralytics/segm/person_yolov8m-seg.pt",
                homepage="https://hf-mirror.com/Bingsu/adetailer",
    ...
    "https://github.com/shiimizu/ComfyUI-PhotoMaker-Plus": {
        "models": [
            AIResourceModel(
                ...
                url="https://hf-mirror.com/andrey18106/visionatrix_models/resolve/main/insightface/buffalo_l.zip",
                homepage="https://github.com/deepinsight/insightface",
